package com.sunflower.chaperone.ui.screens.wanderer.locationSharing
...
import com.sunflower.chaperone.R
...
fun LocationSharingScreen(
    ...
    goToWalkerFeedBackScreen: (Int) -> Unit
) {
    ...
    val walkerLocation by viewModel.walkerLocation.collectAsState()
        ...
        is RoomUiState.Success -> {
            ...
            Box(Modifier.fillMaxSize()) {
                GoogleMap(
                    ...
                    LaunchedEffect(myLocation) {
                        myLocation?.let {
                            wandererMarkerState.position = it
                        }
                    }
                    ...
                    myLocation?.let {
                        Marker(
                            ...
                            title = "You (${roomInfo.wandererName})",
                    ...
                    LaunchedEffect(walkerLocation) {
                        walkerLocation?.let {
                            Log.d("Walker Location", it.toString())
                    ...
                    walkerLocation?.let {
                        Marker(
                            ...
                            title = roomInfo.walkerName,
                            icon = BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE),
                            snippet = "Walker location"
                        )
                ...
                Column(
                    ...
                    Button(
                        onClick = {
                            val walkerId = viewModel.roomInfo.walkerId
                            viewModel.completeWalk() {
                                if (sharingLocation) {
                                    viewModel.toggleShareLocation()
                                    goToWalkerFeedBackScreen(walkerId)
                                } else {
                                    goToWalkerFeedBackScreen(walkerId)
                                }
                            }
